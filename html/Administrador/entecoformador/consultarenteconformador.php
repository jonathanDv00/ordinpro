...
$stmt = new enteconformador_controlador();
            ...
            <div class="VentanaProcesos col-lg-10 shadow-lg p-3 mb-5  rounded my-custom-scrollbar ">
                <div class="row mensaje">
                    <div class="offset-lg-4  ">
                        <h4>Consultar entecoformador</h4>
                    </div>
                </div>
                <div class="row linea ">
                ...
                <div class=" aprendices row shadow p-4 ">
                    ...
                    <div class="col-2">
                            <label for="nombre">Nit Empresaril:</label><input type="text" id="nombre" class="form-control"  name="nit">
                        </div>
                    <div class="col-2">
                    ...
                    <input type="submit" value="Buscar Instructor" class="btn btn-info " name="buscar">
                </div>
                    </form>
                </div>
                <br>
...
<?php 
foreach ($stmt->consultarenteconformador() as $entecoformador) {
echo'
<tr>
<td>'.$entecoformador['NIT_cof'].'</td>
<td>'.$entecoformador['nombre_cof'].'</td>
<td>'.$entecoformador['direccion_cof'].'</td>
<td>'.$entecoformador['tel_fijo_cof'].'</td>
<td>'.$entecoformador['cel_cof'].'</td>
<td>'.$entecoformador['correo_cof'].'</td>
<td>'.$entecoformador['nombre_dep'].'-'.$entecoformador['nombre_mun'].'-'.$entecoformador['nombre_zon'].'-'.$entecoformador['nombre_bar'].'</td>
 <td class="btn-group">
<a href="actualizarEnteCoformador_vista.php?ident='.$entecoformador['id_cof'].'" class="btn icon-edit " id="prueba"></a>
</tr>
';
}
?>
