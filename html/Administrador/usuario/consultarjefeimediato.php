...
$stmt = new jefesInmediato_controlador();
...
<body background="../../../img/fondoabs.jpg">
            ...
            <div class="VentanaProcesos col-lg-10 shadow-lg p-3 mb-5  rounded my-custom-scrollbar ">
                <div class="row">
                    <div class="offset-lg-4 mensaje">
                        <h4>Consultar Jefe Inmediato</h4>
                    </div>
                </div>
                <br>
                <br>
                <div class=" aprendices row shadow p-4 ">
                    ...
                    <div class="col-2">
                            <label for="nombre">Documento:</label><input type="text" id="documento" class="form-control"  name="documento">
                        </div>
                  <div class="col-2">
                        <label for="nombre">Correo:</label><input type="text" id="correo" class="form-control" name="correo">
                    </div>
                    <div class="col-2">
                        <label for="nombre">Nombre empresa:</label><input type="text" id="nombreempresa" class="form-control" name="nombreempresa">
                    </div>
                    <br>
                    <br>

                    <div class="col-3 mt-4">
                    <input type="submit" value="Buscar jefe Inmediato" class="btn btn-info " name="buscar">
                </div>
                    </form>
                </div>
                <br>
    ...
    <thead>
        ...
        <td>Ente conformador</td>

        
        <td>accion</td>
    </thead>
<?php 
foreach ($stmt->consultarjefe() as $jefeimediato) {
echo'
<tr>
<td>'.$jefeimediato['nombre_tipodoc'].'</td>
<td>'.$jefeimediato['num_doc_jef'].'</td>
<td>'.$jefeimediato['nombre_jef'].'</td>
<td>'.$jefeimediato['apellidos_jef'].'</td>
<td>'.$jefeimediato['celular_jef'].'</td>
<td>'.$jefeimediato['correo_us'].'</td>
<td>'.$jefeimediato['nombre_cof'].'</td>
 <td class="btn-group">
  <a href="" class="btn icon-envelope-o " id="prueba"></a>
  <a href="actualizarJefeInmediato_vista.php?idjf='.$jefeimediato['id_jef'].'" class="btn icon-edit " id="prueba"></a>
                                ';
                                }
                                ?>
